...
/*
    ...
    for (unsigned int i =0u; i < 4u; ++i)
    {
      ...
      {
        if(!vertex_B_is_surface[j])
          continue;

        if(vertex_B_is_used[j])
          continue;
        ...
        V const n = (bj-ai) / distance;
        V const p = (ai+bj)*VT::half();
    ...
    //--- Search for V-E cases -------------------------------------------------
    {
      ...
      for (unsigned int i =0u; i < 4u; ++i)
      {
        ...
        for (unsigned int k =0u; k < 6u; ++k)
        {
          ...
          if(!edge_B_is_surface[k])
            continue;

          V const & p_a  = A.p(i);
          V const & p_b0 = B.p( edge_to_vertex[k][0] );
          V const & p_b1 = B.p( edge_to_vertex[k][1] );
      ...
      for (unsigned int i =0u; i < 4u; ++i)
      {
        ...
        for (unsigned int k =0u; k < 6u; ++k)
        {
          ...
          V const & p_b  = B.p(i);
          V const & p_a0 = A.p(edge_to_vertex[k][0]);
          V const & p_a1 = A.p(edge_to_vertex[k][1]);
