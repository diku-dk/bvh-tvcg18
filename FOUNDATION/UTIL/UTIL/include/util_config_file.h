...
namespace util
{
  ...
  public:
    ...
    std::string get_path(std::string const & name, std::string const & default_value) const
    {
      std::string path = get_value(name, default_value);

      // possibly resolve home folder
