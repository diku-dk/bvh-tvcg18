...
namespace tiny
{
    ...
    */
     ...
     *
     * @param value   The number of radians that should be converted into degrees.
     */
    template<typename T>
    inline T to_degrees(T const & value)
    {
      return value*detail::radian<T>();
    }

    /**
     * Use this to convert degrees into radians
     *
     * @param value   The number of degrees that should be converted into radians.
     */
    template<typename T>
    inline T to_radians(T const & value)
    {
      return value*detail::degree<T>();
    }
